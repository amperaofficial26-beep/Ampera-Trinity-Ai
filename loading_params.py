...
def _rgb(hex_color: str) -> str:
    """'#EDE2D1' -> '237,226,209' (untuk ditanam ke rgba() di CSS)."""
    h = hex_color.lstrip("#")
...
@keyframes trinitySpin {
  ...
  12%  { transform: scale(1.22) rotate(0deg);   filter: drop-shadow(0 0 8px rgba(__GLOW__,.85)); }
  24%  { transform: scale(1)    rotate(0deg);   filter: drop-shadow(0 0 3px rgba(__GLOW__,.55)); }
  36%  { transform: scale(1.22) rotate(0deg);   filter: drop-shadow(0 0 8px rgba(__GLOW__,.85)); }
  48%  { transform: scale(1)    rotate(0deg);   filter: drop-shadow(0 0 4px rgba(__GLOW__,.65)); }
  60%  { transform: scale(1.15) rotate(180deg); filter: drop-shadow(0 0 14px rgba(__GLOW__,1)); }
  72%  { transform: scale(1)    rotate(360deg); filter: drop-shadow(0 0 4px rgba(__GLOW__,.65)); }
  86%  { transform: scale(1.08) rotate(360deg); filter: drop-shadow(0 0 6px rgba(__GLOW__,.75)); }
...
def param_loading_html(indices: list[int] | None = None,
    ...
    return (_HTML
            ...
            .replace("__GLOW__", _rgb(WARNA_GLOW))
