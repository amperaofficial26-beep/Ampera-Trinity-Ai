# -*- coding: utf-8 -*-
"""
PENANGKAP ARTEFAK (tanpa panel).

Yuki menulis blok kode ```...``` -> ambil_artefak() memotongnya dari teks
chat, menyimpannya sebagai "file" di st.session_state.artifacts, lalu
menyisipkan kartu ringkas (chip) di bubble chat.

CATATAN: Panel kanan (render_panel, _css_panel, _render_daftar, _render_isi,
tombol buka/tutup, salin, unduh ZIP, dll.) sudah DIHAPUS BERSIH dari file ini
dan akan dibuat ulang dari nol. Yang tersisa hanya logika penangkapan artefak
yang dipakai chat_handlers.py.
"""
