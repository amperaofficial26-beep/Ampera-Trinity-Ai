...
def inject_code_loading_css() -> None:
    """Kosongkan karena CSS dan JavaScript sudah tertanam langsung di dalam HTML."""
    pass

def code_loading_html(nama_file: str = "", done: bool = False) -> str:
    """Mengembalikan animasi loading HTML berbasis JavaScript."""
    if done:
        return ""

    return """
    <h2 class="sr-only">Loading gabungan bergaya ASCII: simbol matematika dan aneh, potongan kode dengan angka bergulir, dan metrik progress bar, dengan kecepatan lebih lambat</h2>
    ...
    (function(){
      ...
      // --- Scene: rumus matematika kompleks ---
      function runSymbols(){
        const items = [
      ...
      // --- Scene: simbol-simbol aneh/langka ---
      ...
      // --- Scene: potongan kode dengan angka speedometer ---
      function runCode(){
        const templates = [
          ['const x =', 1, 999, ''],
          ['arr[', 0, 99, '] processed'],
